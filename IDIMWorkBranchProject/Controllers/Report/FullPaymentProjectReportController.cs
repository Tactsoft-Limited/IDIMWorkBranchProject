...
namespace IDIMWorkBranchProject.Controllers.Report
{
    public class FullPaymentProjectReportController : Controller
    {
        ...
        public ActionResult FullPaymentProjectReport(ReportFilterVm model)
        {
            ...
            var reportPath = Path.Combine(Server.MapPath("~/Report/rdlc"), "RptFullPaymentByProjectDetails.rdlc");
            return ReportHelper.GenerateReport(reportPath, "FullPaymentByProjectDataSet", data, false, type);
